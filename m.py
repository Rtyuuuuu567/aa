...
bot = telebot.TeleBot('7941732318:AAHz7H5fvn6i9jvJbRvjpnJbOFHkKgfEopw')

# Owner user ID
owner_id = "5859040781"

# Admin user IDs
admin_ids = ["5859040781"]
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access!🚫\n\nOops! It seems like you don't have permission to use the /attack command. "
                    "To gain access and unleash the power of attacks, you can:\n\n👉 Contact an Admin or the Owner:- @Miss_queen19 for approval.\n"
...
Buy From :- @Miss_queen19
Official Channel :- @Miss_queen19
'''
...
3. MAKE SURE YOU JOINED @Miss_queen19 OTHERWISE NOT WORK
...
def send_welcome(message):
   ...
   # btn3 = telebot.types.KeyboardButton('ℹ️ My Info')
    markup.add(btn1)
    bot.send_message(message.chat.id, "Welcome 😄\n Provide powerfull DDOS attack \n 27/7 available \n No cooldown \n Dm For Access :- @Miss_queen19", reply_markup=markup)
